...
export const CardProfile = ({ info }) => {
  const { height, weight, egg_groups = [], abilities = [] } = info
      ...
      <Container className='pt-4'>
        <Row className=''>
          ...
          <Col xs='5' sm='5' md='5' lg='2'>
            <h4 className='profileKey align-left'>{height} m</h4>
          </Col>
          <Col className='margin' xs='5' sm='5' md='5' lg={{size:2, offset:1}}>
            <h4 className='profileKey align-left'>Weight: </h4>
          </Col>
          <Col xs='5' sm='5' md='5' lg='2'>
            <h4 className='profileKey align-left'>{weight} kg</h4>
          </Col>
        </Row>
        <Row className=''>
